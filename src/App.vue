        ...
        <div className='col col-12 col-sm-3'>
          <div class="NavContainer mobile"  :class="[isMenu ? 'activeNav' : '']">
            <div class="d-flex justify-content-between align-items-center">
              <h2 class="mb-0">Naresh Dhondi -- Works</h2>
              <div v-on:click="toggleMenu()" class="d-flex d-sm-none pointer">N</div>
            </div>
            
            <div className='navMenu'>
              <div class="d-flex d-sm-none justify-content-end mx-2 pointer" v-on:click="toggleMenu()">X</div>
